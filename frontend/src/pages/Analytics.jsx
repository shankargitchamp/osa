    ...
    <div className="space-y-8 fade-in" data-testid="analytics-page">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="page-subtitle">Historical threat analysis and trends</p>
        </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="lg:col-span-2 glass-card p-6">
              ...
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={analytics?.daily_stats || []}>
                    ...
                    />
                    <YAxis stroke="rgba(255,255,255,0.08)" tick={{ fill: '#71717A', fontSize: 11, fontFamily: 'IBM Plex Mono' }} width={45} />
                    <Tooltip 
                      contentStyle={{ 
              ...
              <div className="flex justify-center gap-8 mt-4 pt-3 border-t border-white/5">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs text-gray-400 font-medium">Threats</span>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col">
              ...
              <div className="flex justify-center gap-6 pt-3 border-t border-white/5">
                <div className="flex items-center gap-2 text-xs">
                  <div className="w-3 h-3 rounded bg-red-500" />
                  <span className="text-gray-400 font-medium">Threats ({totalThreats})</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
                  <div className="w-3 h-3 rounded bg-green-500" />
                  <span className="text-gray-400 font-medium">Safe ({safeEvents})</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={hourlyData}>
                  ...
                  <XAxis 
                    ...
                    tick={{ fill: '#71717A', fontSize: 11, fontFamily: 'IBM Plex Mono' }}
                  />
                  <YAxis stroke="rgba(255,255,255,0.08)" tick={{ fill: '#71717A', fontSize: 11, fontFamily: 'IBM Plex Mono' }} width={35} />
                  <Tooltip 
                    contentStyle={{ 
                      backgroundColor: '#1c1c22', 
                      border: '1px solid rgba(255,255,255,0.1)',
                  ...
                  />
                  <Bar dataKey="count" fill="#ef4444" radius={[4, 4, 0, 0]} name="Threats" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
